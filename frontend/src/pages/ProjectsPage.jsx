        ...
        <>
            <div className="container-fluid vh-100 px-0">
                <div className="d-flex flex-column flex-md-row h-100 pt-3">
                    <div className="d-flex flex-column nav-pills gap-2 mb-3 w-100" role="tablist" aria-orientation="vertical" style={{ maxWidth: "180px", minWidth: "180px" }}>
                    ...
                    <main className="flex-grow-1 overflow-y-auto overflow-x-hidden h-100 px-0 pb-3 ps-4">
